...
public class AccountLinkingReq_JavaCompute extends MbJavaComputeNode {
		...
		public static String sendSMS(String toPhone, String msg){
			...
			System.setProperty("javax.net.ssl.trustStore", "/home/ace/logs/twilioTrust.jks");
			...
			Message message = Message
					.creator(new com.twilio.type.PhoneNumber("+917720859907"), new com.twilio.type.PhoneNumber(fromPhone), msg)
					.create();
